    ...
    <section className="relative">
      <div className="flex mr-4 justify-end">
        ...
        <p
          ...
          className="flex bg-slate-200 cursor-pointer m-2 p-2 relative w-[40px]"
        >
          ...
          <ul className="divide-y divide-blue-200">
            <li className="flex p-2">
              ...
              <div className="uppercase font-bold p-2  relative">
                <span className="text-2xl absolute right-0 top-10">
                  &times;
                </span>
                <p> Ripe Banana </p>
                <p>3KG</p>
            ...
            <li className="flex p-2">
              <p className="w-[80px] h-[80px] bg-white">
                <img
                  src="https://i.postimg.cc/C5Ks2Pnw/beef.jpg"
                  alt="product-image"
                />
              </p>
